...
| 2026-07-31 | **DR&J** HOTFIX — Phase 1 raw-string \n bug | *(SHA on commit)* | Ashutosh Dixit | **APPLIED to prod without staging pre-approval** — customer-reported outage: JS SyntaxError on tool load. Root cause: patch-drj-phase1.py INSERT_QD3/QF5/QH3/QI3 used raw strings (r'…') that put literal \n into the JS body. All Phase 1/2/3 rebuilt with the fix in place. New js_syntax_check guard added. |
