...
| 2026-07-31 | **DR&J** 4 — Ongoing / hygiene (5 items) | *(SHA on commit)* | Ashutosh Dixit | *pending* | Staging URLs: https://ltm-core.s3.us-east-1.amazonaws.com/Data-Residency-Jurisdiction-Audit-staging.html + https://ltm-core.s3.us-east-1.amazonaws.com/dr-j-changelog-staging.html · sources:[{name,url}] on all 10 regulations (32 URLs); framework version stamp on report cover; ragForRegulation fix; customer-facing changelog page; DR&J added to REFRESH-CADENCE.md. |
