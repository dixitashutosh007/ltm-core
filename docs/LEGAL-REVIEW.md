...
| 2026-07-31 | **DR&J** 2 — Screening completeness (9 items) | *(SHA on commit)* | Ashutosh Dixit | *pending* | Staging URL: https://ltm-core.s3.us-east-1.amazonaws.com/Data-Residency-Jurisdiction-Audit-staging.html · Q_C1 add Oracle/IBM/Salesforce/Snowflake/Databricks; Q_C2 mirror B1 rows + UK column; Q_A2 expand DORA entity list; Q_G1 fix health wording + add GPAI; Q_H2 add EUCS Basic; Q_J1 cite DORA RTS 4h/72h/1-month; Q_B1 fix financial anchor. Additive. |
